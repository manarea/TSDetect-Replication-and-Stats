...
public class EngineImpl_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "wheel.EngineImpl"; 
  ...
  public static void setSystemProperties() {
    ...
    java.lang.System.setProperty("user.dir", "/home/test-smell/generation-scripts/projects/80_wheelwebtool"); 
  }

  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(EngineImpl_ESTest_scaffolding.class.getClassLoader() ,
      "wheel.components.Image",
      "wheel.MessageSourceResourceBundleImpl$LocalizedBundleKey",
      ...
      "wheel.DevelopmentResourceManager",
      ...
      "wheel.enhance.WheelClassLoader",
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("javax.servlet.ServletContext", false, EngineImpl_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("javax.servlet.http.HttpServletRequest", false, EngineImpl_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("javax.servlet.http.HttpServletResponse", false, EngineImpl_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(EngineImpl_ESTest_scaffolding.class.getClassLoader()); 
